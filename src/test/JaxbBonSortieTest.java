...
public class JaxbBonSortieTest {
    ...
    static {
        ...
        res.add("BS_20180531094000_41101020180000987");// 10 create or edit test
    ...
    public static void main(String[] args) throws SAXException, IOException, JAXBException {
        Object[] resValidate = bonSortieValidator.validate("src/xml/", res.get(11) + ".xml", "BonSortieAck.xsd", 4);
        System.out.println("kokoooo ==> " + resValidate[0] + "::" + resValidate[1]);
